      ...
      <table class="table table-striped table-hover table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="{{url('editPortifolio')}}/{{$portifolio->pid}}" class="btn btn-sm btn-success"><i class="fa fa-edit"></i></a>
              <a href="{{url('deletarPortifolio')}}/{{$portifolio->pid}}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
            </td>
          </tr>
          @endforeach
        </tbody>
